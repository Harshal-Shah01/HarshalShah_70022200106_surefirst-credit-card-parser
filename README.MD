...
1.  Clone the repo:
    ```bash
    git clone https://github.com/Harshal-Shah01/HarshalShah_70022200106_surefirst-credit-card-parser.git
    cd HarshalShah_70022200106_surefirst-credit-card-parser
    ```
...
1.  Run the app:
    ...
    ```
2.  Select a credit card provider from the dropdown or upload the PDF.
...
1.  ```bash
    python main.py
    ```
2.  Enter the PDF filename (from `credit_card_pdfs/` folder)
3.  Extracted data will be printed.
